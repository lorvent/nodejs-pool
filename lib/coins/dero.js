...
function Coin(data){
    ...
    this.coinDevAddress = "dERobKn6RFSbgMEMzcFurMBERbSFr13NkiirjnJarcef3vf3J5RJ7Ve7KFCyZYLsCufwrdab1eEe9QX3M4fxjiPu37UEYEVNcu";  
    this.poolDevAddress = "dERobKn6RFSbgMEMzcFurMBERbSFr13NkiirjnJarcef3vf3J5RJ7Ve7KFCyZYLsCufwrdab1eEe9QX3M4fxjiPu37UEYEVNcu"; 
    ...
    this.exchangeAddresses = [
		"dERokPan5wMCjQCCUTZQakNLqgDPQCnMfUdTH5fLWoBAg3JnU79jNkFarUVGqwJc6R5NW2qLE5iuocmSHgQWgHop1hv7nBsVYT"
    ...
    this.validateAddress = function(address){
		...
		console.log(cnUtil.address_decode(address));
        if (cnUtil.address_decode(address) === this.prefix){
            return true;
        }
		console.log(cnUtil.address_decode_integrated(address));
