...
cd ~
git clone https://github.com/1rV1N-git/nodejs-pool.git  # Change this depending on how the deployment goes.
cd /usr/src/gtest
sudo cmake .
sudo make
...
pm2 start init.js --name=api --log-date-format="YYYY-MM-DD HH:mm:ss Z" -- --module=api
